...
marp2video v0.2.0 introduces automatic subtitle generation using speech-to-text, OmniVoice integration for unified TTS/STT provider abstraction, and dictionary-based case correction for professional subtitle output.
...
- New `marp2video subtitle` command for generating subtitles from audio
...
- Unified TTS provider interface via [OmniVoice](https://github.com/agentplexus/omnivoice)
...
~/.config/marp2video/dictionaries/*.json
./dictionaries/*.json
```
...
- Added `github.com/agentplexus/omnivoice` v0.4.1 for unified TTS/STT interface
- Added `github.com/agentplexus/omnivoice-deepgram` v0.3.0 for Deepgram STT support
- Bumped `github.com/grokify/mogo` to v0.73.2 for `SanitizePath` support

## Installation

```bash
go install github.com/grokify/marp2video/cmd/marp2video@v0.2.0
```
...
- [OmniVoice](https://github.com/agentplexus/omnivoice)
